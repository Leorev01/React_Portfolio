...
export const HERO_CONTENT = `I am a passionate Software Engineer with hands-on experience in full stack web development and data analysis. I have developed skills in front-end technologies such as React and Next.js, along with back-end technologies like Node.js, Express.js, MySQL, PostgreSQL, and MongoDB. My goal is to leverage my knowledge and experience to create innovative solutions that drive business growth and deliver exceptional user experiences.`;

export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating efficient and user-friendly web applications. As a software engineer and computer science grad, I have gained hands-on experience with various technologies, including React, Next.js, Node.js, MySQL, PostgreSQL, Python, Git and more. My interest in web development grew from a fascination with creating interactive experiences and finding innovative solutions to real-world problems. This passion has evolved into a commitment to continuous learning and adaptation to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy playing chess, exploring the outdoors, and taking part in sports. These experiences help me maintain a balanced lifestyle and inspire my creativity.`;
...
export const PROJECTS = [
  ...
  },
  {
    ...
    technologies: ["HTML", "TailwindCSS", "React", "NextJs", "Clerk Authnetication", "Stream"],
  },
  {
